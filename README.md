...
To build the final jar and optimize the medicalSystem application for production, run:
...
Then navigate to [http://localhost:9502](http://localhost:9502) in your browser.
